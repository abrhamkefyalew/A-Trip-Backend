...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('bids', function (Blueprint $table) {
            ...
            $table->unique(['order_user_id', 'vehicle_id']);

            $table->integer('price_total'); // THIS IS DAILY PRICE   // when the bid is accepted by individual customer              // it will be multiplied by the (total days of the order + 1) and will go to order_users table column = price_total
