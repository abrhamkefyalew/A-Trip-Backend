...
class StoreContractDetailRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'price_contract' => 'required|integer|between:1,9999999',
            'price_vehicle_payment' => 'required|integer|between:1,9999999',
            ...
            'price_fuel_payment_constant' => 'required|numeric|between:1,9999999.99',
