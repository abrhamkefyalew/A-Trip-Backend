...
class BOACustomerPaymentService
{
    ...
    private $invoiceUserIdValWithPrefix;
    ...
    public function __construct($invoiceUserIdValue)
    {
        ...
        $this->invoiceUserIdValWithPrefix = "ICI-" . (string) $invoiceUserIdValue; // add the ICI- prefix to indicate the invoice code is for INDIVIDUAL CUSTOMER INITIAL payment // we will use it later when the callback comes from the banks
    }
    ...
    public function initiateInitialPaymentForVehicle()
    {
        ...
        $boaData = [
            ...
            'reference_number' => (string) $this->invoiceUserIdValWithPrefix,
